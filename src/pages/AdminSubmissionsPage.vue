<template>
  <section class="page">
    ...
    <div v-else-if="submissions.length" class="submission-list" :class="`submission-list--${viewMode}`">
      <mdui-card v-for="item in submissions" :key="item.id" class="section-card submission-card" :class="`submission-card--${viewMode}`">
        <template v-if="viewMode === 'grid'">
          <div class="submission-grid-item" @click="openReviewDialog(item)">
