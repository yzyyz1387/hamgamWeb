<template>
  <section class="page profile-page">
    <div class="profile-hero-card section-card">
        ...
        <div class="profile-hero-right profile-hero-right--social">
          ...
          <div class="profile-hero-toolbar profile-hero-toolbar--social">
            ...
            <div class="action-row profile-hero-action-group">
              ...
              <mdui-button v-if="auth.profile?.uid" variant="outlined" @click="goPublicProfile">访客视角</mdui-button>
      ...
      <div class="profile-hero-disclosure">
        <button type="button" class="profile-hero-disclosure__toggle" @click="summaryExpanded = !summaryExpanded">
          <span>个人信息</span>
          <mdui-icon
            name="keyboard_arrow_down--rounded"
            class="profile-hero-disclosure__icon"
            :class="{ 'profile-hero-disclosure__icon--open': summaryExpanded }"
          ></mdui-icon>
        </button>
        <transition name="profile-summary-slide">
          <div v-if="summaryExpanded" class="profile-hero-summary">
    ...
    <div class="hero-grid profile-dashboard-grid">
      ...
      <div class="profile-dashboard-sidebar">
        <div v-if="profilePanels.length" class="profile-panel-stack">
          <component
            :is="panel.component"
...
const profileForm = reactive({ nickname: '', bio: '', grid_locator: '' })
...
.profile-hero-disclosure {
  padding: 0 28px 24px;
  margin-top: -6px;
}

.profile-hero-disclosure__toggle {
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.profile-hero-disclosure__icon {
  transition: transform 0.25s ease;
}

.profile-hero-disclosure__icon--open {
...
.profile-summary-slide-enter-active,
.profile-summary-slide-leave-active {
  transition: opacity 0.25s ease, transform 0.25s ease;
}

.profile-summary-slide-enter-from,
.profile-summary-slide-leave-to {
  opacity: 0;
  transform: translateY(-8px);
}

.profile-hero-summary .profile-summary-list {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 12px;
}

.profile-hero-summary .profile-summary-item {
  padding: 14px 16px;
  border-radius: 18px;
  background: rgba(255, 255, 255, 0.72);
  border: 1px solid rgba(24, 34, 44, 0.06);
...
.profile-hero-summary .profile-summary-item span {
  display: block;
  font-size: 13px;
  color: #6b7280;
  margin-bottom: 6px;
...
.profile-hero-summary .profile-summary-item strong {
  color: #0f172a;
  font-size: 16px;
  line-height: 1.5;
